                    ...
                    <div id="RC_SubModulesParentDiv" data-bind="foreach: typeListing">
                        <div class="RC_TypeRow" data-bind="visible: typeToShow(), style: { background: typeBackgroundColor(), color: typeTextColor() }">
                            ...
                            <div class="RC_TypeInfo">
                                <%--Type Name--%>
                                <div data-bind="text: typeName, click: htmlBulkUploadGrid.onClickType" class="RC_TypeName SRMRuleCatalogParentEllipses">
                                </div>
                                <%--Parent Type--%>
                                <div data-bind="text: parentType, visible: parentTypetoShow" class="RC_ParentType SRMRuleCatalogParentEllipses"></div>
                            </div>
                            ...
                            <div class="SMRuleSetup_Rules" iscollapsed="0" data-bind="visible: ruletoShow()">
                                <div class="SMRuleSetup_arrow SMRuleSetup_hideContents" style="display: inline-block; cursor: pointer; left: 14px; position: relative; width: 98%; margin-top: 5px; margin-bottom: 5px;" data-bind="visible: attributeToDisplay">
                                    ...
                                    <div class="SMRuleSetup_Attr_Ruletype_Container">
                                        ...
                                        <div class="SMRuleSetup_attrname" data-bind="text: attributeToDisplay">
                                ...
                                <div class="SMRuleSetup_hidden_contents" data-bind="foreach: ruletypes">
                                    ...
                                    <div data-bind="foreach: attrRules">
                                        <div class="SMRuleSetup_AttributeRulesBinding" data-bind="attr: { 'rulegroupname': ruleGroupName, 'rulename': ruleName, 'priority': priority, 'ruleState': ruleState ? 'true' : 'false', 'ruletext': ruleText, 'commonRuleSectypes': commonRuleSectypes }">
                                            <br />
                                            <div class="SMRuleSetup_ruleObjectContainer">
                                                ...
                                                <div class="SMRuleSetup_pud">
                                                    <div class="SMRuleSetup_isCommonRule">
                                                    ...
                                                    <div class=" SMRuleSetup_priority" data-bind="visible: ($parent.ruleTypeName != 'Conditional Filter'), text: priority" style="cursor: default;">
                                                    </div>
                                                    <!-- State button start -->
                                                    <div class="SMRuleSetup_change_state" data-bind="visible: ($parent.ruleTypeName != 'Conditional Filter')">
                                                        <div data-bind="css: { 'SMRuleSetup_RuleStateON': ruleState, 'SMRuleSetup_RuleStateOFF': !ruleState }">
                                                        </div>
                                                    </div>
                                                    <!-- State button end-->
                                                </div>
