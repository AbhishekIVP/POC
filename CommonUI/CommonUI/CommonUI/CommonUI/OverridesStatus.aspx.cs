...
{
    public partial class OverridesStatus : BasePage
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            string JSScript = "var os_serverSideControls = " + serializer.Serialize(GetOverrideStatusControlInfo()) + "; var os_serverSideValues = " + serializer.Serialize(GetOverrideStatusInfo()) + "; overrideStatus._entityTypeID= " + (serializer.Serialize(this.Request.QueryString["entityTypeId"])) + ";";
