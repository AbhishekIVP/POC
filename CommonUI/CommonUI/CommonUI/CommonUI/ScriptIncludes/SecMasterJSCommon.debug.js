...
SecMasterJSCommon.SearchPageIdentifier = function() { 
    ...
    /// </field>
    /// <field name="UpdateSecurityNew" type="Number" integer="true" static="true">
    /// </field>
};
...
SecMasterJSCommon.SMSCommons.encodeURI = function SecMasterJSCommon_SMSCommons$encodeURI(url) {
    /// <summary>
...
SecMasterJSCommon.SMSCommons.openWindowToSetOverrides = function SecMasterJSCommon_SMSCommons$openWindowToSetOverrides(secID) {
    /// <param name="secID" type="Array" elementType="String">
    /// </param>
    var objUIService = new com.ivp.secm.ui.Service();
    objUIService.SetValuesToSessionObjectForSetOverrides(secID, Number.parseInvariant(eval('Math.round(Math.random() * 10090)').toString()), Function.createDelegate(null, SecMasterJSCommon.SMSCommons._onSuccessOpenWindowToSetOverrides), Function.createDelegate(null, SecMasterJSCommon.SMSCommons.onFailure));
}
SecMasterJSCommon.SMSCommons._onSuccessOpenWindowToSetOverrides = function SecMasterJSCommon_SMSCommons$_onSuccessOpenWindowToSetOverrides(result, eventArgs) {
    /// <param name="result" type="Object">
    /// </param>
    /// <param name="eventArgs" type="Object">
    /// </param>
    var url = 'CommonUI/SRMOverridesStatus.aspx?screenName=search&productName=secmaster&identifier=Common_OverrideStatus';
    ...
    SecMasterJSCommon.SMSCommons.createTab('Common_OverrideStatus', url, SecMasterJSCommon.SMSCommons.getGUID(), 'Set Overrides');
}
...
SecMasterJSCommon.SMSCommons.openWindowToSelectSecurity_EditandCompareSecurity = function SecMasterJSCommon_SMSCommons$openWindowToSelectSecurity_EditandCompareSecurity(pageIdentifier, lblId, txtBoxId, isMaster, underyingSecurityTypeId) {
    /// <param name="pageIdentifier" type="SecMasterJSCommon.SearchPageIdentifier">
    /// </param>
    /// <param name="lblId" type="String">
    /// </param>
    ...
    /// </param>
    var url = String.format('SMSearch.aspx?isMaster={0}&underlying_sectype_id={1}&LabelControl={2}&txtBox={3}&identifier={4}&mode=nw', isMaster.toString(), underyingSecurityTypeId, lblId, txtBoxId, SecMasterJSCommon.SearchPageIdentifier.toString(pageIdentifier)) + '&UniquePageIdentifier=' + eval('Math.round(Math.random() * 10090)');
    SecMasterJSCommon.SMSCommons.openConstSearch_EditandCompareSecurity(url);
}
SecMasterJSCommon.SMSCommons.openConstSearch_EditandCompareSecurity = function SecMasterJSCommon_SMSCommons$openConstSearch_EditandCompareSecurity(url) {
    /// <param name="url" type="String">
    /// </param>
    eval('$(\'#divConstSearch\').outerHeight($(window).height()); \r\n            $(\'#divConstSearch\').outerWidth($(window).width());\r\n            $(\'#divConstSearch\').css(\'display\', \'\');\r\n\r\n            $(\'#iframeConstSearch\').outerHeight($(window).height() - $(\'#divSearchConstPopupTopPanel\').outerHeight() - 2);\r\n            $(\'#iframeConstSearch\').outerWidth($(window).width());\r\n            $(\'#iframeConstSearch\').prop(\'src\',\'' + url + '\') ');
}
...
SecMasterJSCommon.SMSCommons.getParentWithSelector = function SecMasterJSCommon_SMSCommons$getParentWithSelector(element, parentSelector) {
    /// <param name="element" type="String">
    /// </param>
    /// <param name="parentSelector" type="String">
    /// </param>
    /// <returns type="SecMasterJSCommon.WrapperDom"></returns>
    var obj = null;
    eval('obj = $(element).closest(parentSelector);');
    return obj;
}
...
SecMasterJSCommon.SMSCommons.openWindowAsOfSecurity = function SecMasterJSCommon_SMSCommons$openWindowAsOfSecurity(secId, date, knowledgeDate, cuUniqueId) {
    ...
    var url = '';
    if (cuUniqueId != null && cuUniqueId !== '') {
        url = 'SMCreateUpdateSecurityNew.aspx?identifier=UpdateSecurityNew&pageType=AsOf&secId=' + secId + '&effectiveDate=' + date + '&knowledgeDate=' + knowledgeDate + ('&UniqueId=' + newUniqueId);
        window.location.href = url;
    }
    else {
        url = 'SMCreateUpdateSecurityNew.aspx?identifier=UpdateSecurityNew&pageType=AsOf&mode=nw&secId=' + secId + '&effectiveDate=' + date + '&knowledgeDate=' + knowledgeDate + ('&UniqueId=' + newUniqueId);
        SecMasterJSCommon.SMSCommons.createTab('UpdateSecurityNew', url, newUniqueId, '');
    }
}
SecMasterJSCommon.SMSCommons.openWindowForEntity = function SecMasterJSCommon_SMSCommons$openWindowForEntity(entityCode, mode) {
    ...
    var pageIdentifier = '';
    if (mode === 'Edit') {
        pageIdentifier = 'UpdateEntityFromSearch';
    }
    else {
        pageIdentifier = 'ViewEntityFromSearch';
    }
    var newUniqueId = 'unique_' + SecMasterJSCommon.SMSCommons.getGUID();
    eval('\r\n            function getRMLeftMenu() {\r\n                var refMparent = window.parent;\r\n                while ((refMparent.leftMenu == null || refMparent.leftMenu == undefined)) {\r\n                    if (refMparent.parent != refMparent)\r\n                        refMparent = refMparent.parent;\r\n                    else\r\n                        break;\r\n                }\r\n                return refMparent.leftMenu;\r\n            }\r\n            var path = window.location.protocol + \'//\' + window.location.host;\r\n            var pathname = window.location.pathname.split(\'/\');\r\n\r\n            $.each(pathname, function(ii, ee) {\r\n                    if ((ii !== 0) && (ii !== pathname.length - 1))\r\n                        path = path + \'/\' + ee;\r\n                });\r\n            path = path.replace(\'/App_Dynamic_Resource\', \'\');\r\n            path = path.replace(\'/CommonUI\',\'\');\r\n            path += \'/\';\r\n            var url = path + \'/App_Dynamic_Resource/RefMasterUI,com.ivp.refmaster.ui.Container.aspx?entityCode=' + entityCode + '&pageIdentifier=' + pageIdentifier + '\';\r\n            getRMLeftMenu().createTab(\'dummy\' + \'' + newUniqueId + '\', url, \'' + newUniqueId + '\', \'' + entityCode + '\');');
}
SecMasterJSCommon.SMSCommons.openWindowForSecurityWithHiglight = function SecMasterJSCommon_SMSCommons$openWindowForSecurityWithHiglight(isEditMode, secId, AttrIdForHighlight, MultiInfoIdForHighlight, newWindow, isNewWindowMode, openByDefault, externalVendorId, cuUniqueId, ModuleId) {
    /// <param name="isEditMode" type="Boolean">
    /// </param>
    /// <param name="secId" type="String">
    /// </param>
    ...
    /// <param name="cuUniqueId" type="String">
    /// </param>
    /// <param name="ModuleId" type="Object">
    /// </param>
    var newUniqueId = (newWindow) ? ('unique_' + SecMasterJSCommon.SMSCommons.getGUID()) : cuUniqueId;
    ...
    var queryStringStr = (window.location.search === '' && window.location.search == null) ? new Array(0) : window.location.search.substring(1, window.location.search.length).split('&');
    var externalMethodParam = '';
    var tabNameForHighlightParam = '';
    for (var i = 0; i < queryStringStr.length; i++) {
        var keyValPair = queryStringStr[i].split('=');
        if (keyValPair[0].toLowerCase() === 'externalmethod') {
            externalMethodParam = '&ExternalMethod=' + keyValPair[1];
        }
        else if (keyValPair[0].toLowerCase() === 'tabnameforhighlight') {
            tabNameForHighlightParam = '&TabNameForHighlight=' + keyValPair[1];
        }
    }
    var url = 'SMCreateUpdateSecurityNew.aspx?identifier=UpdateSecurityNew&pageType=' + ((isEditMode) ? 'Edit' : 'View') + '&secId=' + secId + (((AttrIdForHighlight !== 0 && AttrIdForHighlight !== -1) && (MultiInfoIdForHighlight === 0 || MultiInfoIdForHighlight === -1)) ? '&AttrIdForHighlight=' + AttrIdForHighlight : '') + (((MultiInfoIdForHighlight !== 0 && MultiInfoIdForHighlight !== -1) && (AttrIdForHighlight === 0 || AttrIdForHighlight === -1)) ? '&MultiInfoIdForHighlight=' + MultiInfoIdForHighlight : '') + ('&UniqueId=' + newUniqueId) + openByDefaultUrl + ((ModuleId == null) ? ('&ModuleId=' + 3) : ('&ModuleId=' + ModuleId)) + externalMethodParam + tabNameForHighlightParam;
    var nw = url + '&mode=nw';
    if (newWindow) {
...
SecMasterJSCommon.SMSCommons.openWindowForCreateSecurity = function SecMasterJSCommon_SMSCommons$openWindowForCreateSecurity(sectypeId, newWindow, isNewWindowMode, cuUniqueId, openByDefault, externalVendorId, moduleId) {
    /// <param name="sectypeId" type="Number" integer="true">
    /// </param>
    /// <param name="newWindow" type="Boolean">
    /// </param>
    ...
    /// <param name="externalVendorId" type="Number" integer="true">
    /// </param>
    /// <param name="moduleId" type="Number" integer="true">
    /// </param>
    var newUniqueId = (newWindow) ? ('unique_' + SecMasterJSCommon.SMSCommons.getGUID()) : cuUniqueId;
    var openByDefaultUrl = '&OpenByDefault=' + openByDefault;
    switch (openByDefault) {
    ...
    if (moduleId === 9) {
        openByDefaultUrl += '&moduleId=' + moduleId;
    }
    var url = 'SMCreateUpdateSecurityNew.aspx?identifier=CreateSecurityNew&sectypeId=' + sectypeId + ('&UniqueId=' + newUniqueId) + openByDefaultUrl;
    var nw = url + '&mode=nw';
    if (newWindow) {
        SecMasterJSCommon.SMSCommons.createTab('CreateSecurityNew', nw, newUniqueId, '');
    }
...
SecMasterJSCommon.SMSCommons.openSecurity = function SecMasterJSCommon_SMSCommons$openSecurity(isEditMode, secId, effectiveDate, newWindow, isNewWindowMode, overrideIsActivateWhenSave, btnPageRefreshId, secIdForClone, deleteExistingSecurity, cloneTimeSeries, openByDefault, externalVendorId, cuUniqueId, ModuleId) {
    /// <param name="isEditMode" type="Boolean">
    /// </param>
    /// <param name="secId" type="String">
    /// </param>
    ...
    var list = [];
    list[0] = secId;
    eval('dict = SMExecuteSynchronously(\'BaseUserControls/Service/Service.asmx\', \'GetSecuritiesActiveState\', { lstSecId: ' + Sys.Serialization.JavaScriptSerializer.serialize(list) + ', ModuleId: ' + ((ModuleId == null) ? 3 : ModuleId) + ' }).d;');
    eval('for(var item in dict){ if (dict[item].Is_Active) { SecMasterJSCommon.SMSCommons.openWindowForSecurity(isEditMode, item, newWindow, isNewWindowMode, openByDefault, externalVendorId, cuUniqueId, ModuleId);} else{SecMasterJSCommon.SMSCommons.openWindowDraftedSecurity(item, isEditMode, ((dict[item].Effective_Date != null && dict[item].Effective_Date != \'\') ? dict[item].Effective_Date : effectiveDate), dict[item].Is_Draft, newWindow, isNewWindowMode, overrideIsActivateWhenSave, btnPageRefreshId, secIdForClone, deleteExistingSecurity, cloneTimeSeries, cuUniqueId);}}');
}
SecMasterJSCommon.SMSCommons.openSecurityFromRealtimeStatus = function SecMasterJSCommon_SMSCommons$openSecurityFromRealtimeStatus(isEditMode, secId, effectiveDate, newWindow, isNewWindowMode, overrideIsActivateWhenSave, btnPageRefreshId, secIdForClone, deleteExistingSecurity, cloneTimeSeries, openByDefault, externalVendorId, cuUniqueId, ModuleId) {
    /// <param name="isEditMode" type="Boolean">
    /// </param>
    /// <param name="secId" type="String">
    /// </param>
    ...
    list[0] = secId;
    eval('dict = SMExecuteSynchronously(\'BaseUserControls/Service/Service.asmx\', \'GetSecuritiesActiveState\', { lstSecId: ' + Sys.Serialization.JavaScriptSerializer.serialize(list) + ', ModuleId: ' + ((ModuleId == null) ? 3 : ModuleId) + ' }).d;');
    eval('function makeUrl(url, parameters) \r\n                { \r\n                    if (parameters == undefined) \r\n                        parameters = {}; \r\n                    var queryParams = []; \r\n                    var keys = Object.keys(parameters); \r\n                \r\n                    for (var i in keys) \r\n                    { \r\n                        queryParams.push(keys[i] + \'=\' + parameters[keys[i]]); \r\n                    } \r\n                \r\n                    if (queryParams.length > 0) \r\n                        url += \'?\' + queryParams.join(\'&\'); \r\n                    return url; \r\n                }       \r\n\r\n                for(var item in dict) \r\n                { \r\n                    if (dict[item].Is_Draft) \r\n                    { \r\n                        SecMasterJSCommon.SMSCommons.openWindowDraftedSecurity(item, isEditMode, ((dict[item].Effective_Date != null && dict[item].Effective_Date != \'\') ? dict[item].Effective_Date : effectiveDate), dict[item].Is_Draft, newWindow, isNewWindowMode, overrideIsActivateWhenSave, btnPageRefreshId, secIdForClone, deleteExistingSecurity, cloneTimeSeries, cuUniqueId); \r\n                    }  \r\n                    else \r\n                    { \r\n                        if (dict[item].Is_Active) \r\n                        { \r\n                            SecMasterJSCommon.SMSCommons.openWindowForSecurity(isEditMode, item, newWindow, isNewWindowMode, openByDefault, externalVendorId, cuUniqueId, ModuleId); \r\n                        } else \r\n                        { \r\n                            var url = \'\'; \r\n                            var params = {}; \r\n                            var identifier = \'\'; \r\n                            var tabText = \'\'; \r\n                            var uniqueId = newWindow ? \'unique_\' + SecMasterJSCommon.SMSCommons.getGUID() : cuUniqueId;\r\n                            url = \'SMCreateUpdateSecurityNew.aspx\'; \r\n                            params.identifier = \'CreateSecurityNew\'; \r\n                            params.pageType = isEditMode ? \'EditDraft\' : \'ViewDraft\'; \r\n                            params.secId = item; \r\n                            params.UniqueId = uniqueId; \r\n                            params.ModuleId = 3; \r\n                            if(newWindow) { params.mode = \'nw\'; }\r\n                            params.isInactiveSecurity = \'1\'; \r\n                            params.isActivateWhenSave = \'true\'; \r\n                            params.btnPageRefreshId=btnPageRefreshId; \r\n                            identifier = \'viewSecurity\'; \r\n                            tabText = \'View Security\'; \r\n\r\n                            url = makeUrl(url, params); \r\n                            var nw = url + \'&mode=nw\';\r\n\r\n                            if (newWindow)\r\n                            {   \r\n                                SecMasterJSCommon.SMSCommons.createTab(identifier, url, uniqueId, tabText, true); \r\n                            }\r\n                            else   \r\n                            {\r\n                                window.location.href = ((isNewWindowMode) ? nw : url);\r\n                            }\r\n                        } \r\n                    } \r\n                }');
}
SecMasterJSCommon.SMSCommons.openWindowForSecurity = function SecMasterJSCommon_SMSCommons$openWindowForSecurity(isEditMode, secId, newWindow, isNewWindowMode, openByDefault, externalVendorId, cuUniqueId, ModuleId) {
    /// <param name="isEditMode" type="Boolean">
    /// </param>
    /// <param name="secId" type="String">
    /// </param>
    ...
    /// <param name="ModuleId" type="Object">
    /// </param>
    SecMasterJSCommon.SMSCommons.openWindowForSecurityWithHiglight(isEditMode, secId, 0, 0, newWindow, isNewWindowMode, openByDefault, externalVendorId, cuUniqueId, ModuleId);
}
...
SecMasterJSCommon.SMSCommons.openWindowForDraftedSecurity = function SecMasterJSCommon_SMSCommons$openWindowForDraftedSecurity(isEditDraftMode, secId, newWindow, isNewWindowMode, openByDefault, externalVendorId, cuUniqueId, draftedSecurity) {
    /// <param name="isEditDraftMode" type="Boolean">
    /// </param>
    /// <param name="secId" type="String">
    /// </param>
    /// <param name="newWindow" type="Boolean">
    ...
    /// <param name="cuUniqueId" type="String">
    /// </param>
    /// <param name="draftedSecurity" type="String">
    /// </param>
    SecMasterJSCommon.SMSCommons.openWindowForDraftedSecurityWithHiglight(isEditDraftMode, secId, 0, 0, newWindow, isNewWindowMode, openByDefault, externalVendorId, cuUniqueId, draftedSecurity);
}
SecMasterJSCommon.SMSCommons.openWindowForDraftedSecurityWithHiglight = function SecMasterJSCommon_SMSCommons$openWindowForDraftedSecurityWithHiglight(isEditMode, secId, AttrIdForHighlight, MultiInfoIdForHighlight, newWindow, isNewWindowMode, openByDefault, externalVendorId, cuUniqueId, draftedSecurity) {
    /// <param name="isEditMode" type="Boolean">
    /// </param>
    /// <param name="secId" type="String">
    /// </param>
    ...
    var url = 'SMCreateUpdateSecurityNew.aspx?identifier=UpdateSecurityNew&pageType=' + ((isEditMode) ? 'Edit' : 'View') + '&secId=' + secId + (((AttrIdForHighlight !== 0 && AttrIdForHighlight !== -1) && (MultiInfoIdForHighlight === 0 || MultiInfoIdForHighlight === -1)) ? '&AttrIdForHighlight=' + AttrIdForHighlight : '') + (((MultiInfoIdForHighlight !== 0 && MultiInfoIdForHighlight !== -1) && (AttrIdForHighlight === 0 || AttrIdForHighlight === -1)) ? '&MultiInfoIdForHighlight=' + MultiInfoIdForHighlight : '') + ('&UniqueId=' + newUniqueId) + openByDefaultUrl + '&DraftedSecurity=' + draftedSecurity;
    var nw = url + '&mode=nw';
    if (newWindow) {
        SecMasterJSCommon.SMSCommons.createTab('UpdateSecurityNew', nw, newUniqueId, '');
    }
...
SecMasterJSCommon.SMSCommons.createTab = function SecMasterJSCommon_SMSCommons$createTab(identifier, url, uniqueId, tabText) {
    ...
    /// </param>
    eval('var patha = window.location.protocol + \'//\' + window.location.host;\r\n                    var pathnamea = window.location.pathname.split(\'/\');\r\n\r\n                    $.each(pathnamea, function (ii, ee) {\r\n                        if ((ii !== 0) && (ii !== pathnamea.length - 1))\r\n                            patha = patha + \'/\' + ee;\r\n                    });');
    eval('var parent = getTopMostParent(); if(!parent.leftMenu) { if(\'' + url + '\'.includes(patha)) {window.open(\'' + url + '\'); } else { window.open(patha + \'/\' + \'' + url + '\'); } } else parent.leftMenu.createTab(\'' + identifier + '\',\'' + url + '\',\'' + uniqueId + '\',\'' + tabText + '\');');
}
...
SecMasterJSCommon.SMSCommons.smExecuteSynchronously = function SecMasterJSCommon_SMSCommons$smExecuteSynchronously(url, method, args) {
    /// <param name="url" type="String">
    /// </param>
    /// <param name="method" type="String">
    /// </param>
    ...
    /// <returns type="Object"></returns>
    var result = null;
    eval('result = SMExecuteSynchronously(url, method, args).d;');
    return result;
}
...
SecMasterJSCommon.SMSSectypeRuleAttributeInfo = function SecMasterJSCommon_SMSSectypeRuleAttributeInfo() {
    ...
    /// </field>
    /// <field name="attributeIdNew" type="String">
    /// </field>
}
...
SecMasterJSCommon.SMSecurityTimeSeries = function SecMasterJSCommon_SMSecurityTimeSeries() {
    /// <field name="startDate" type="Array" elementType="String">
    /// </field>
    /// <field name="endDate" type="Array" elementType="String">
    /// </field>
    ...
    /// </field>
    /// <field name="isCommonLeg" type="Boolean">
    /// </field>
    /// <field name="legName" type="String">
    /// </field>
    /// <field name="sectypeName" type="String">
    /// </field>
    /// <field name="primaryAttrName" type="String">
    /// </field>
}
...
SecMasterJSCommon.SMSecurityTimeSeriesMultiSec = function SecMasterJSCommon_SMSecurityTimeSeriesMultiSec() {
    ...
    /// </field>
    /// <field name="basketListCommonLeg" type="Array" elementType="String">
    /// </field>
    /// <field name="secId" type="String">
    /// </field>
