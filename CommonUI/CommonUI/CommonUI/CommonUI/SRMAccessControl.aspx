<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRMAccessControl.aspx.cs" Inherits="com.ivp.common.CommonUI.CommonUI.SRMAccessControl" %>
...
<head runat="server">
    ...
    <script src="js/thirdparty/MicrosoftAjax.debug.js"></script>
    <script type="text/javascript">
        $(document).ready(function (e) {
            ...
            RADUserManagement.initialize(initObj);
        });
