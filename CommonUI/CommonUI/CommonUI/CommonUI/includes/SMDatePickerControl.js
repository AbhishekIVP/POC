var smdatepickercontrol = (function () {
    ...
    function createHTML($object) {
        ...
        var width = '', width2 = '';
        if ($object.dateOptions.length == 7)
        { width2 = '30%'; }
        else
        { width2 = '40%'; }
        ...
        if ($object.selectedTopOption == 5) {
            if (($object.selectedNtimeText == "" || $object.selectedNtimeText == undefined))
            { $('#lastNtimeid_' + counter).val('15'); $('#nextNtimeid_' + counter).val('15'); }
            else
            { $('#lastNtimeid_' + counter).val($object.selectedNtimeText); smselect.setOptionByText($('#smselect_ddllastNtime_' + counter), $object.selectedNtimeOption); }
        }
        else if ($object.selectedTopOption == 6) {
            if (($object.selectedNtimeText == "" || $object.selectedNtimeText == undefined))
            { $('#nextNtimeid_' + counter).val('15'); $('#lastNtimeid_' + counter).val('15'); }
            else
            { $('#nextNtimeid_' + counter).val($object.selectedNtimeText); smselect.setOptionByText($('#smselect_ddlnextNtime_' + counter), $object.selectedNtimeOption); }
        }
    ...
    function setCalender(type, id, counter, text, value) {
        ...
        if (type == 0) {//last
            ...
            promise.success(function (data) {
                ...
                if (value == 1 || value.toUpperCase() == "DAYS")
                { text = parseInt(text, 10) + 1; NtimeOption = "days"; StartDay = new Date(today.getFullYear(), today.getMonth(), (today.getDate() + parseInt(text, 10))); text = -(parseInt(text, 10) - 1) }
                else if (value == 2 || value.toUpperCase() == "WEEKS")
                { NtimeOption = "weeks"; StartDay = new Date(today.getFullYear(), today.getMonth(), (today.getDate() + (7 * parseInt(text, 10)))); text = -(parseInt(text, 10)) }
                else if (value == 3 || value.toUpperCase() == "MONTHS")
                { NtimeOption = "months"; StartDay = new Date(today.getFullYear(), today.getMonth() + parseInt(text, 10), today.getDate()); text = -(parseInt(text, 10)) }
                else if (value == 4 || value.toUpperCase() == "QUATERS")
                { NtimeOption = "quaters"; StartDay = new Date(today.getFullYear(), today.getMonth() + (3 * parseInt(text, 10)), today.getDate()); text = -(parseInt(text, 10)) }
                else if (value == 5 || value.toUpperCase() == "YEARS")
                { NtimeOption = "years"; StartDay = new Date(today.getFullYear() + parseInt(text, 10), today.getMonth(), today.getDate()); text = -(parseInt(text, 10)) }
        ...
        else //next
        {
            ...
            promise.success(function (data) {
                ...
                { NtimeOption = "weeks"; StartDay = new Date(today.getFullYear(), today.getMonth(), (today.getDate() + (7 * parseInt(text, 10)))) }
                else if (value == 3 || value.toUpperCase() == "MONTHS")
                { NtimeOption = "months"; StartDay = new Date(today.getFullYear(), today.getMonth() + parseInt(text, 10), today.getDate()) }
                else if (value == 4 || value.toUpperCase() == "QUATERS")
                { NtimeOption = "quaters"; StartDay = new Date(today.getFullYear(), today.getMonth() + (3 * parseInt(text, 10)), today.getDate()) }
                else if (value == 5 || value.toUpperCase() == "YEARS")
                { NtimeOption = "years"; StartDay = new Date(today.getFullYear() + parseInt(text, 10), today.getMonth(), today.getDate()) }
        ...
        if (freq == 3) { //monthly
            ...
            if (customOption == 0) { //From
                ...
                if (val1 < val3) { var yr1 = val1; var yr2 = val3; var qm1 = val2; var qm2 = val4; }
                    ...
                    if (val4 < val2)
                    { var qm1 = val4; var qm2 = val2; }
                    else
                    { var qm1 = val2; var qm2 = val4; }
                }
        ...
        $('#smdd_' + counter).unbind('click').click(function (e) {
            ...
            if ($("#" + id).children(".smdd_lastNtime_section").css('visibility') == 'visible') {
                ...
                if ($("#" + id).children(".smdd_custom_section").attr('selectedRadioOption') == '0') { //From
                    ...
                    //month
                    if (freqOption != 5)
                    { ddlMonQuarSelectedIndex = smselect.getSelectedOption($("#smselect_fromSelect1ddl_" + id))[0].value; textddlMonQuarSelected = smselect.getSelectedOption($("#smselect_fromSelect1ddl_" + id))[0].text; }
                    //year
                    ...
                    //month
                    if (freqOption != 5)
                    { ddlMonQuarSelectedIndex = smselect.getSelectedOption($("#smselect_btwnSelect1ddl_" + id))[0].value; textddlMonQuarSelected = smselect.getSelectedOption($("#smselect_btwnSelect1ddl_" + id))[0].text; }
                    //year
                    ddlYearSelectedIndex = smselect.getSelectedOption($("#smselect_btwnTimeSelect1ddl_" + id))[0].value;
                    //Right Parameter
                    //month
                    if (freqOption != 5)
                    { ddlMonQuar2SelectedIndex = smselect.getSelectedOption($("#smselect_btwnSelect2ddl_" + id))[0].value; textddlMonQuar2Selected = smselect.getSelectedOption($("#smselect_btwnSelect2ddl_" + id))[0].text; }
                    //year
                    ...
                    //month
                    if (freqOption != 5)
                    { ddlMonQuarSelectedIndex = smselect.getSelectedOption($("#smselect_priorSelect1ddl_" + id))[0].value; textddlMonQuarSelected = smselect.getSelectedOption($("#smselect_fromSelect1ddl_" + id))[0].text; }
                    //year
