...
(function (root, factory) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        /* DURGESH */
        var DRPTemplate = '<div class="daterangepicker dropdown-menu" id="' + this.element.attr('id') + '_dateInfo" style="margin-right:9px !important;">' +
            ...
            '</div>' +
            /* DURGESH */
            '<button class="applyBtn custom-applyBtn" disabled="disabled" ></button>&nbsp;' +
            /* DURGESH */
            '<button class="cancelBtn custom-cancelBtn" ></button>' +
            '</div>' +
            '</div>' +
            '</div>';
            ...
            if (this.singleDatePicker) {
                ...
                if (!this.timePicker) {
                    ...
                    if (Object.keys(options.ranges).length == 0)
                        this.container.find('.ranges ul').hide(); //(As of Date + time picker - custom range) -> hides custom range <li>
                }
