<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRMBusinessCalender.aspx.cs" Inherits="com.ivp.common.CommonUI.CommonUI.SRMBusinessCalender" %>
...
<head runat="server">
    ...
    <script src="includes/RADBusinessCalendar.pagescript.js"></script>
    <link href="css/thirdparty/bootstrap.min.css" rel="stylesheet" />
    <link href="css/RADBusinessCalendar.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        $(document).ready(function (e) {
            ...
            RADCalendarConfig.initialize(initObj);
        });
