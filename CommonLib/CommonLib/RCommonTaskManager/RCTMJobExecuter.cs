...
namespace com.ivp.rad.RCTMService
{
    class RCTMJobExecuter
    {
        ...
        static string DBConnectionId = RADConfigReader.GetConfigAppSettings("RADDBConnectionId");
        ...
        public void RunScheduledJobs(string clientName)
        {
            ...
            try
            {
                ...
                lock (locker)
                {
                    ...
                    dsJobs = objSchedulerDal.GetAllRunnableJobs(minutesToCheckBack);
            ...
            {
                CTMService.ErrorOccurredWhileTriggeringScheduledJob[clientName] = true;
        ...
        {
            objSchedulerDal.UpdateJobInfo(Convert.ToInt32(jobID));
        ...
        public void UpdateNextScheduledTime()
        {
            ...
            RDBConnectionManager dbconn = RDALAbstractFactory.DBFactory.GetConnectionManager("CTMDB");
