...
namespace com.ivp.rad.CTMProcess
{
    class RCTMProcssStart
    {
        ...
        private void CreateJobLogger(TaskInfo data)
        {
            ...
            CreateLog(fileName, string.Format("Started created job specific logger for job id -{0} and client : {1}", data.FlowID, clientName));
            ...
            logger = RLogFactory.CreateLogger("CTMProcess");
            logger.Error("Log File Created for CTMProcess.RCTMProcessStart");
