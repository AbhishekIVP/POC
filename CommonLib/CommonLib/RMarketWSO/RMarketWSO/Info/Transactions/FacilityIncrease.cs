...
namespace com.ivp.rad.RMarketWSO.Info.Transactions
{
    class FacilityIncrease
    {
        ...
        [CustomAttributes(HeaderName = "FacilityIncreaseData", HasInnerProperty = true)]
        public FacilityIncreaseData FacilityIncreaseData { get; set; }
