...
namespace com.ivp.rad.RMarketWSO.Info.Transactions
{
    class ReceiveOldInterest
    {
        ...
        [CustomAttributes(HeaderName = "ReceiveOldInterestData", HasInnerProperty = true)]
        public ReceiveOldInterestData ReceiveOldInterestData { get; set; }
