...
namespace com.ivp.rad.RMarketWSO.Info.Transactions
{
    class FXAdjustment
    {
        ...
        [CustomAttributes(HeaderName = "FXAdjustmentData", HasInnerProperty = true)]
        public FXAdjustmentData FXAdjustmentData { get; set; }
    ...
    class FXAdjustmentData
    {
        [CustomAttributes(HeaderName = "desc", HasInnerProperty = false)]
        public string Description { get; set; }
        [CustomAttributes(HeaderName = "unfundedadj", HasInnerProperty = false)]
        public string UnfundedAdjustment { get; set; }
    }
}
