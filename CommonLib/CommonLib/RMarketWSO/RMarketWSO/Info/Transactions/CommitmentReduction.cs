...
namespace com.ivp.rad.RMarketWSO.Info.Transactions
{
    class CommitmentReduction
    {
        ...
        [CustomAttributes(HeaderName = "CommitmentReductionData", HasInnerProperty = true)]
        public CommitmentReductionData CommitmentReductionData { get; set; }
