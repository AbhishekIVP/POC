...
namespace com.ivp.rad.RMarketWSO.Info.Transactions
{
    class CommitmentIncrease
    {
        ...
        [CustomAttributes(HeaderName = "CommitmentIncreaseData", HasInnerProperty = true)]
        public CommitmentIncreaseData CommitmentIncreaseData { get; set; }
