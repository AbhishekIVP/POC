...
namespace com.ivp.rad.RMarketWSO.Info.Transactions
{
    class ProcessReceivable
    {
        ...
        [CustomAttributes(HeaderName = "ProcessReceivableData", HasInnerProperty = true)]
        public ProcessReceivableData ProcessReceivableData { get; set; }
