...
namespace com.ivp.rad.RMarketWSO.Info.Transactions
{
    class PaydownPartial
    {
        ...
        [CustomAttributes(HeaderName = "PaydownPartialData", HasInnerProperty = true)]
        public PaydownPartialData PaydownPartialData { get; set; }
    ...
    class PaydownPartialData
    {
        ...
        [CustomAttributes(HeaderName = "adjpositionglobpct", HasInnerProperty = false)]
        public double AdjustPositionGlobalPercent { get; set; }

        [CustomAttributes(HeaderName = "isoptional", HasInnerProperty = false)]
